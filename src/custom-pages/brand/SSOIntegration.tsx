...
export default function SSOIntegration({ user: _user, portalType, brandId, isEmbedded, onRefreshBrand }: SSOIntegrationProps) {
                      ...
                      <ListItemText
                        primary={
                          <div className="flex items-center justify-between">
                            ...
                            {b.whitepass_review?.integration_status === 'rejected' && (
                        ...
                        secondary={
                          <div className="space-y-0.5 mt-0.5">
                            ...
                            {b.whitepass_review?.integration_status === 'rejected' && b.whitepass_review?.review_notes && (
                              <Typography sx={{ fontSize: '9.5px', color: '#e11d48', fontWeight: 600, whiteSpace: 'normal', lineHeight: 1.15 }}>
                                Reason: {b.whitepass_review.review_notes}
                              </Typography>
                            )}
                          </div>
                        }
